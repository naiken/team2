...
public class GResult extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.training_result2);

        back_btn = (ImageButton) findViewById(R.id.backbutton2);
        ...
        DataManager.getInstance(this).saveCP(
         ...
         // テキストビューの取得
         obtain_cp_text = (TextView) findViewById(R.id.obtain_cp2);
         obtain_guts_text = (TextView) findViewById(R.id.obtain_guts2);
         total_guts_text = (TextView) findViewById(R.id.total_guts2);
         ...
         // クリックリスナーを登録
//         back_btn.setOnClickListener(new ButtonClickListener());
