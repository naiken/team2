...
public class EggScreen extends Activity implements View.OnTouchListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.egg_screen);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EggScreen.this, Tutorial.class);
        ...
        // ImageView = (ImageView) findViewById(R.id.imageview_first);
    }
