...
public class TrainingResult extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// テキストビューの取得
		obtain_cp_text = (TextView) findViewById(R.id.obtain_cp);
		obtain_guts_text = (TextView) findViewById(R.id.obtain_guts);
		total_guts_text = (TextView) findViewById(R.id.total_guts);
