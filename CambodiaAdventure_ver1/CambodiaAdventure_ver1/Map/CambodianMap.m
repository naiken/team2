...
- (IBAction)back:(UIButton *)sender {
    TitleScreen *title = [self.storyboard instantiateViewControllerWithIdentifier:@"TitleID"];
    [self presentViewController:title animated:YES completion:nil];
}
...
//    UDPush();
    ...
    if ([[UDGetValue(@"LVL2") objectAtIndex:6] intValue] >= 6 && [[UDGetValue(@"LVL2") objectAtIndex:4] boolValue]) {
        ...
        self.phnompenhLetter.alpha = 0.5;
    }
